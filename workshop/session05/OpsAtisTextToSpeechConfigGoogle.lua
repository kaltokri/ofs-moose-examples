...
local srsGoogleKey = cfgTable['SrsGoogleKey']
local srsGender = cfgTable['SrsGender']
local srsCulture = cfgTable['SrsCulture']
local srsVoice = cfgTable['SrsVoice']
BASE:E(srsGoogleKey)

-- ATIS Batumi Airport on 143.00 MHz AM.
atisBatumi=ATIS:New( AIRBASE.Caucasus.Batumi, 251.00 )
...
--atisBatumi:SetSRS( srsFolderPath, "female", "en-US", nil, srsPort, srsGoogleKey )
atisBatumi:SetSRS( srsFolderPath, srsGender, srsCulture, srsVoice, srsPort, srsGoogleKey )
